...
import { useUI } from "@nuxt/ui/dist/runtime/composables/useUI";
import { useFormGroup } from "@nuxt/ui/dist/runtime/composables/useFormGroup";
import { mergeConfig } from "@nuxt/ui/dist/runtime/utils";
import type { NestedKeyOf, Strategy } from "@nuxt/ui/dist/runtime/types";
// @ts-expect-error
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const { emitFormBlur, emitFormInput, inputId, color, size, name } = useFormGroup(
      props,
      config
    );
