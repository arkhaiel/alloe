...
Le site alloé est développé et maintenu par Mathieu NICOLAS, ci-après dénommé "".
...
Constituant le contrat entre le prout et l'utilisateur à travers le site, l'accès au site doit être précédé de l'acceptation de ces CGU. L'accès à cette plateforme signifie l'acceptation des présentes CGU.
